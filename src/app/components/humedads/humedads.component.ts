...
@Component({
  selector: 'app-humedads',
  templateUrl: './humedads.component.html',
  styleUrls: ['./humedads.component.css']
})

export class HumedadsComponent implements OnInit {
  ...
  constructor(
    ...
    this.db.object('ESP32_APP1/TEMPERATURA-SUELO').valueChanges().subscribe((dato: any) => {

      this.temperatura.push(dato)
      console.log('Humedad:', this.temperatura);
